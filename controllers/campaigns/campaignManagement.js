...
/**
 * Enhanced Campaign Creation - Form Method with Product Integration
 */
...
// Add these new routes to your existing router in campaignManagement.js:

// Enhanced form-based creation
router.post(
  "/create/form",
  jwtAuth.requireBrand(),

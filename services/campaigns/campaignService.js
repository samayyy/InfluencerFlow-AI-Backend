  ...
  buildSearchFilters (campaignData, brandData) {
    ...
    if (brandData.ai_generated_overview) {
      ...
      if (aiOverview.collaboration_fit?.ideal_creators) {
        ...
        else if (idealCreators.includes('beauty')) { filters.niche = 'beauty_fashion' } else if (idealCreators.includes('fitness')) { filters.niche = 'fitness_health' } else if (idealCreators.includes('food')) filters.niche = 'food_cooking'
        else if (idealCreators.includes('travel')) { filters.niche = 'lifestyle_travel' }
      }
    }
